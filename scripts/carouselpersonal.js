document.addEventListener("DOMContentLoaded", function () {
  ...
  const prev = document.querySelector(".staff-carousel .prev");
  const next = document.querySelector(".staff-carousel .next");
  ...
  const totalSlides = Math.ceil(totalCards / itemsPerSlide);
   ...
   if (dots.length < totalSlides) {
    console.warn("Advertencia: hay menos dots que slides. Considera agregarlos dinámicamente.");
  }
